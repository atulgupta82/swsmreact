...
const AddBeneficiaryPreview = ({showPreview,setShowPreview,formData,handleSubmit}) => {
            ...
            show={showPreview} onHide={handleClose}>
                ...
                <Modal.Body className='previewModalBody'>
                    ...
                    <Table striped bordered hover>
                        ...
                        <tbody> 
                            <tr>
                                <td>{formData.is_agreement_available}</td>
                                <td>{formData.contract_copy && formData.contract_copy.length>0?"Yes":"No"}</td>
                                <td>{formData.reg_cert && formData.reg_cert.length>0?"Yes":"No"}</td>
                                <td>{formData.pan_card && formData.pan_card.length>0?"Yes":"No"}</td>
                                <td>{formData.authority_letter && formData.authority_letter.length>0?"Yes":"No"}</td>
                                <td>{formData.authority_letter && formData.authority_letter.length>0?"Yes":"No"}</td>
                                <td>{formData.cancel_cheque && formData.cancel_cheque.length>0?"Yes":"No"}</td>
                            </tr>                         
                        </tbody>
                    </Table>
                    ...
                    <Table striped bordered hover>
                        ...
                        <tbody> 
                            <tr>
                                <td>{formData.p_name}</td>
                                <td>{formData.p_pan_no}</td>
                                <td>{formData.p_mobile}</td>
                                <td>{formData.p_email}</td>
                                <td>{formData.p_address_1}</td>
                                <td>{formData.p_address_2}</td>
                                <td>{formData.p_state_id}</td>
                                <td>{formData.p_district}</td>
                                <td>{formData.p_pincode}</td>
                            </tr>                         
                        </tbody>
                    </Table>
                </Modal.Body>
...
export default AddBeneficiaryPreview